...
if authentication_status is False:
    ...
    col1.metric("TOTAL PÉRDIDA", f"{mermados} Prods")
    col2.metric("MERMADOS", f"{mermados} Prods")
    col3.metric("DEGUSTADOS", f"{degustados} Prods")
    col4.metric("DAÑADOS", f"{daniados} Prods")
